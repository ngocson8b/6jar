...
function updateFieldValue(field, action) {
  ...
  if (removeKeys) {
    var _ret = function () {
      var removeKeysArray = typeof removeKeys === 'string' ? [removeKeys] : removeKeys;
  ...
  var updatedField = (0, _mapValues2.default)(value, function (subValue, index) {
    var subField = field[index] || (0, _formReducer.createInitialState)(model + '.' + index, subValue);
    ...
    return _icepick2.default.merge(subField, _icepick2.default.set(changedFieldProps, 'value', subValue));
  });

  var dirtyFormState = _icepick2.default.merge(field.$form || _formReducer.initialFieldState, _icepick2.default.set(changedFieldProps, 'retouched', field.submitted || field.$form && field.$form.retouched));
