<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Ngocson', 'ngocson', array('class'=>'control-label')); ?>

				<?php echo Form::textarea('ngocson', Input::post('ngocson', isset($comment) ? $comment->ngocson : ''), array('class' => 'col-md-8 form-control', 'rows' => 8, 'placeholder'=>'Ngocson')); ?>
